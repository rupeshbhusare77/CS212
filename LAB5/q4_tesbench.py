...
for i in range(15):
    ...
    rdt_sender.N=n	# Window size for the sender
    rdt_receiver.N=n # Window size for the receiver (Note: This is ignored in the GBN protocol, but required in the SR protocol)
    rdt_sender.K=k # Packet sequence numbers range from 0 to K-1
    rdt_receiver.K=k # Packet sequence numbers range from 0 to K-1
    ...
    TOTAL_SIMULATION_TIME=200000  # <==== Total simulation time. Increase it as you like.
    t=0
